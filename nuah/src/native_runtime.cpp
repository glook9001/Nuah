...
int run_nuah_jni(const NativeLaunchOptions& options,
  ...
  if (!settings_json || !*settings_json) {
    ...
    if (turbo_mode) {
      ...
      set_client_setting(target_settings, "FFlagRenderMeshPartBatching", "true");
      set_client_setting(target_settings, "FFlagRenderEnableInstancing", "true");
      set_client_setting(target_settings, "FFlagRenderEnableTextureAtlas", "true");
      set_client_setting(target_settings, "FFlagDebugDisableSkyReflections", "true");
      set_client_setting(target_settings, "FFlagDebugDisableAtmosphereReflections", "true");
      set_client_setting(target_settings, "FFlagRenderNoColorCorrection", "true");
