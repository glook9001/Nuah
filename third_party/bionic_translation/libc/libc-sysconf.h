...
// fixed up with `clang-format --style="{BasedOnStyle: LLVM, IndentWidth: 8, UseTab: Always, BreakBeforeBraces: Linux, AllowShortIfStatementsOnASingleLine: false, IndentCaseLabels: false, ColumnLimit: 0, AlignConsecutiveMacros: AcrossEmptyLines, AllowShortCaseLabelsOnASingleLine: true}"`
