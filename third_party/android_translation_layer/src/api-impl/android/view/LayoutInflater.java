	...
	void rInflate(XmlPullParser parser, View parent, final AttributeSet attrs, boolean finishInflate) throws Exception {
		...
		while (((type = parser.next()) != XmlPullParser.END_TAG
			...
			if (name.equals("requestFocus")) {
				// Android XML uses this empty tag to request initial focus.  The
				// desktop widget tree can honor it directly without throwing a
				// pending JNI exception during Activity startup.
				parent.requestFocus();
