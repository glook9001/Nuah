...
public class InputDevice {
	...
	public List<InputDevice.MotionRange> getMotionRanges() {
		ArrayList<InputDevice.MotionRange> ranges = new ArrayList<InputDevice.MotionRange>();
		for (int i = 0; i < 32; i++) {
			ranges.add(new MotionRange(i, getSources()));
		}
		return ranges;
	}
	...
	public MotionRange getMotionRange(int axis, int source) {
		return new MotionRange(axis, source);
	}

	public MotionRange getMotionRange(int axis) {
		return getMotionRange(axis, getSources());
	}
	...
	public class MotionRange {
		...
		public MotionRange(int axis, int source) {
			this.axis = axis;
			this.source = source;
		}
